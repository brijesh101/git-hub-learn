...
// Input validations
if(!empty($email) and !empty($password) and !empty($full_name))
	{
		$sql = mysql_query("INSERT into users(user_email,user_password,user_fullname) values('$email',md5('$password'),'$full_name')");
		if($sql){
